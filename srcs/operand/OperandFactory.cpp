...
static long double parseFloatStrict(std::string const& s)
{
 ...
 std::unique_ptr<IOperand const> OperandFactory::createOperand(eOperandType type, std::string const& value)
{
...
std::unique_ptr<IOperand const> OperandFactory::createInt8(std::string const& value) const
{
    ...
    return std::unique_ptr<IOperand const>(new Operand<int8_t>(static_cast<int8_t>(v), Int8));
}
...
std::unique_ptr<IOperand const> OperandFactory::createInt16(std::string const& value) const
{
    ...
    return std::unique_ptr<IOperand const>(new Operand<int16_t>(static_cast<int16_t>(v), Int16));
}
...
std::unique_ptr<IOperand const> OperandFactory::createInt32(std::string const& value) const
{
    ...
    return std::unique_ptr<IOperand const>(new Operand<int32_t>(static_cast<int32_t>(v), Int32));
}
